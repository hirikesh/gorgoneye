...
bool CAMShiftDetector::locate(const Mat& srcImg, const Mat& srcMsk, Rect& srcRoi)
{
    ...
    // Search Window begins at region of interest determined by last
    // run of CAMShift. The algorithm will auto increase search window.
    RotatedRect rotTemp;
    rotTemp = CamShift(backProjImg, // back projected image
                       searchRoi,   // initial search window
